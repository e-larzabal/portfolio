...
('9ca7457e-cb37-4841-98fd-d5f6ad272ddf','Saint-Jean de luz','Centre d''affaire','ZI de Jalday',NULL,64500,'2000-03-27','2000-10-31','<ul>
 <li>Développements d''évolutions des applications internes en <strong>Visual basic</strong>  </mi>
 <li>Base de données <strong>Access</strong> </mi>
</ul>','logo_Olano.png','Olano Organisation','Analyste programmeur',NULL)
...
,('b4aacb63-36c8-4f99-bb2f-7b98f39769b1','Bayonne','6 chem Hayet',' ',NULL,64100,'2013-11-01','2018-11-30','<ul>
 <li>Lead applications, automates, ERP & services web </li>
 <li>Langages/outils <strong>WinDev</strong>, <strong>WebDev</strong>, <strong>NodeJS</strong>, <strong>InnosSetup/Pascal objet</strong>, <strong>Bash</strong>, <strong>HTML5 & CSS3</strong> </li>
 <li>Bases de données <strong>HFSQL C/S</strong> &  <strong>MySQL</strong> </li>
</ul>','logo_AMTRUST.png','AM TRUST IT','Concepteur Développeur',NULL)
,('d67912dc-2911-452a-a2f8-09bc81f7f2b1','Bidart','Technopole Izarbel','45, allée T. Monod ',NULL,64210,'2019-07-15','2020-03-17','<ul>
 <li>Développements spécifiques clients </li>
 <li>Bases de données <strong>Oracle</strong> </li>
</ul>','logo_odeis.jpg','RFI Informatique','Ingénieur développement WinDev',NULL)
...
,('d9fc7a46-2fb3-4a2a-9167-9d54f7274f7d','BIRON','2 Allée DE L''INNOVATION',' ',NULL,64300,'2001-04-09','2008-04-30','<ul>
 <li>Lead interfaces avec les logiciels RH et paie </li>
 <li>Bases de données <strong>HyperFileSQL</strong> </li>
</ul>','logo_OCTIME.png','OCTIME SA','Analyste programmeur Windev WebDev',NULL)
;
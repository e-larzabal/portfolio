...
<li class="text-color-white">Travail en équipe,</li>
<li class="text-color-white">Travail en remote,</li>
<li class="text-color-white">Autonomie.</li>
</ul>',NULL,'Organisation',5,'icon-meter'),
	 ('92ed45a2-b923-4b0c-9089-ad3111d1f432','<ul class="skill-grid-ul">
<li class="text-color-white">Spring,</li>
<li class="text-color-white">Hibernate,</li>
<li class="text-color-white">Thymeleaf.</li>
</ul>',NULL,'Librairies',4,'icon-tools'),
	 ('bd554947-92e9-4579-bf39-9a9c3dc41a7f','<ul class="skill-grid-ul"> 
 <li class="text-color-white">Sérieuse, </li>
 <li class="text-color-white">Attentive,</li>
